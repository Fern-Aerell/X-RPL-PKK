...
import 'package:mypgri/system/data_rpl.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:url_launcher/url_launcher_string.dart';

class RplScreen extends StatefulWidget {
  RplScreen({super.key});

  @override
  State<RplScreen> createState() => _RplScreenState();
}

class _RplScreenState extends State<RplScreen> {
  @override
    ...
    return Scaffold(
        ...
        body: Padding(
          ...
          child: ListView(children: [
            ...
            for (int i = 0; i < DataRpl.length; i++) ...[
              SizedBox(
                height: 10,
              ),
              Container(
